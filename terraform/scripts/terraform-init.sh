...
AKS_NAME_SECRET_NAME="aks-${DEPARTMENT}-aks-${LOCATION}-${ENVIRONMENT}-ssh"
BUILD_SECRET_NAME="vm-build-${DEPARTMENT}-gateway-${LOCATION}-${ENVIRONMENT}-ssh"
PSQL_SECRET_NAME="psql-${DEPARTMENT}-storages-${LOCATION}-${ENVIRONMENT}"
DEV_SECRET_NAME="vm-dev-${DEPARTMENT}-gateway-${LOCATION}-${ENVIRONMENT}"
